#ifndef MENTAL_GLFW_WINDOW_H
#define MENTAL_GLFW_WINDOW_H

#include <GLFW/glfw3.h>
#include <cstdint>
#include <memory>

const static int MENTAL_GLFW_CONTEXT_VERSION_MINOR=3;
const static int MENTAL_GLFW_CONTEXT_VERSION_MAJOR=3;
...
class MFW_C_Window
{
    private:
        ...
        uint32_t _size[2] = {800, 600};


        std::unique_ptr<GLFWwindow, GLFWWindowDeleter> _window_uptr = nullptr;
    ...
    public:
        ...
        [[clang::always_inline]]
        [[nodiscard]]       bool            windowShouldClose() const               { return glfwWindowShouldClose(this->_window_uptr.get()); }
                            void            run();
}; // class MFW_C_Window

#endif // MENTAL_GLFW_WINDOW_H
